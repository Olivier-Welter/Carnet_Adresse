...
public class Accueil extends Application {
    @Override
    public void start(Stage accueilStage) {
        ...
        //Scene
        Scene sceneAccueil = new Scene(grille, 520, 280); // Nouvelle scène contenant la grille créée, largeur, hauteur
        accueilStage.setTitle("Carnet Accueil"); // Titre fenêtre principale
        accueilStage.setScene(sceneAccueil); // Choix de la scène à afficher dans la fenêtre principale
        accueilStage.show(); // Affichage fenêtre principale
