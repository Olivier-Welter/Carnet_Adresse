...
public class FormulaireSaisie extends Application {
    ...
    public void start(Stage Stage) {
        ...
        formulaireStage.setTitle("Formulaire de saisie"); // Titre fenêtre principale
        formulaireStage.setScene(sceneFormulaire); // Choix de la scène à afficher dans la fenêtre principale
        formulaireStage.show(); // Affichage fenêtre principale
